...
import { Scan, LogOut, Loader2, Calendar, AlertOctagon, Clock, CheckCircle2, XCircle, Sun } from 'lucide-react';
    ...
    <div className="min-h-full bg-slate-100 flex flex-col">
      ...
      <main className="flex-1 p-8 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
            {/* Standard Welcome Banner (Replacement for AI) */}
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
                ...
                <p className="text-2xl font-light leading-relaxed">
                    Życzymy owocnej pracy i miłego dnia!
                </p>
                <p className="text-sm text-blue-200 mt-2 opacity-80">
                   System InfoPoint v1.0 • Ostatnia synchronizacja: {new Date().toLocaleTimeString('pl-PL')}
                </p>
            </div>
